...
public static class DataFunctionExtensions {
    public static Function GetData(this Function function, DataSourceType source, NBTPath path, double scale = 1) {
    ...
    public static Function RemoveData(this Function function, DataSourceType source, NBTPath path) {
        return function.Add($"data remove {source} {path}");
    }
    
    public static Function ModifyData(this Function function, DataSourceType source, NBTPath path, DataOperation operation) {
